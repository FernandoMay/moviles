...
public class TragaPerras extends Activity implements OnClickListener {
    int dificultad = 100;
    int columna;
    ...
    int[] fotoId =
            {R.drawable.banana,
                    R.drawable.cherry,
                    R.drawable.uvas,
                    R.drawable.gallofeliz,
                    R.drawable.ballena,
                    R.drawable.tortugasuerte,
                    R.drawable.ganesha,
                    R.drawable.quetzalcoatl,
                    R.drawable.manekineko
            };
    // Secuencia de imágenes en cada columna
    // Aquí las filas están intercambiadas por las columnas
    int[][] secuencia = {
            {0, 1, 2, 3, 4, 5, 6, 7, 8},
            {8, 7, 6, 5, 4, 3, 2, 1, 0},
            {4, 5, 3, 2, 6, 7, 1, 0, 8}};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tragaperras);
    ...
    class MiAsyncTask extends AsyncTask<Integer, Integer, String> {
        ...
        protected String doInBackground(Integer... parameter) {
            ...
            return "Parar columna " + (columna + 1);
        }
        ...
        protected void onPostExecute(String result) {
            if (continuar[0] == false & continuar[1] == false & continuar[2] == false) {
                if (secuencia[0][1] == secuencia[1][1]
                    ...
                    tv.setText("Suerte la próxima vez");
                }
            } else {
                tv.setText("" + result);
            }
